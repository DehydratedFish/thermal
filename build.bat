...
SET sources="source/thermal.cpp" "source/utf.cpp" "source/io.cpp" "source/font.cpp" "source/renderer.cpp" "source/ui.cpp" "source/ansi_escape_parser.cpp" "source/win32_platform.cpp"
